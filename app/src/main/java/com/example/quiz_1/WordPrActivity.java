...
public class WordPrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_pr);
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedAnsw.isEmpty()){
                    Toast.makeText(WordPrActivity.this, "Выбирете вариант ответа", Toast.LENGTH_SHORT).show();
                } else{
                    Intent intent = new Intent(WordPrActivity.this, WordResActivity.class);
        ...
        btnBack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WordPrActivity.this, MainActivity.class));
                finish();
            }
        });
    }
